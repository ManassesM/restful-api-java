...
import com.manadev.restful.entities.Payment;
import com.manadev.restful.entities.Product;
import com.manadev.restful.entities.User;
import com.manadev.restful.entities.enums.OrderStatus;
import com.manadev.restful.repositories.CategoryRepository;
import com.manadev.restful.repositories.OrderItemRepository;
import com.manadev.restful.repositories.OrderRepository;
import com.manadev.restful.repositories.ProductRepository;
...
public class TestConfig  implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		cat3.getProducts().addAll(Arrays.asList(p1, p3, p4));
		...
		Payment pay1 = new Payment(null, Instant.parse("2021-02-12T16:41:07Z"), o1);
		o1.setPayment(pay1);
